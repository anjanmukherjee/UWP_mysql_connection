...
namespace dbconnection
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private String phpAddress = "file:///C:/xampp/htdocs/test.php";
        ...
        {
            phpAddress = "http://localhost/test.php";
            ...
            {
                tb.Text = "Invalid URI, please re-enter a valid URI";
                return;
            }
            if (resourceUri.Scheme != "http" && resourceUri.Scheme != "https")
            {
                tb.Text = "Only 'http' and 'https' schemes supported. Please re-enter URI";
                return;
            }
            // ---------- end of test--------------------------------------------------------------------- 

            string responseText;
           tb.Text = "Waiting for response ...";
            ...
            catch (Exception ex)
            {
                ...
                tb.Text = "Error = " + ex.HResult.ToString("X") +
                    "  Message: " + ex.Message;
                responseText = "";
            }
           tb.Text = response.StatusCode + " " + response.ReasonPhrase;

            // now 'responseText' contains the response as a verified text. 
            // next 'responseText' is displayed  


          tb.Text = responseText.ToString();
        }
    }
}